...
export function exportReportToPDF(data: ReportData) {
  ...
  doc.text('Generated by DMS v2.0 - Created by Vishal Dhangar', 105, 285, { align: 'center' });
...
export function exportBillToPDF(data: BillData) {
  ...
  doc.text('Generated by DMS v2.0', 105, 285, { align: 'center' });
...
export function exportMonthlyBillToPDF(data: MonthlyBillData) {
  ...
  doc.text('Generated by DMS v2.0 - Dairy Management System', pageWidth / 2, 282, { align: 'center' });
