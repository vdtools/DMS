...
export function exportReportToPDF(data: ReportData) {
  ...
  doc.text('Generated by DMS v2.2 - Created by Vishal Dhangar', 105, 285, { align: 'center' });
...
export function exportBillToPDF(data: BillData) {
  ...
  doc.text('Generated by DMS v2.2', 105, 285, { align: 'center' });
...
export function exportMonthlyBillToPDF(data: MonthlyBillData) {
  ...
  doc.text('Generated by DMS v2.2 - Dairy Management System', pageWidth / 2, 282, { align: 'center' });
